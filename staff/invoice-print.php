 ...
 <table>
   <thead>
    <tr>
      ...
      <td align="left" style="width: 520px;"><font style="font-size: 18px"><b>    PT JASA RAHARJA (PERSERO) <br> Cabang Jambi</b></font>
    </tr>
</thead>
  </table>
  <hr>
...
?>
    ...
    <div class="row invoice-info">
      ...
      <br>
      <br>
      <b><p align='center'><u>______________</u></p></b>
      </div>
      <div class="col-sm-4 invoice-col">
      <p align='center'>Mengetahui<br>Ka. Perw/Ka. Unit SDM & Umum</p>
      <br>  
      <br>
      <b><p align='center'><u>SYAFAAT RAHMAN</u></p></b>
      </div>
      <div class="col-sm-4 invoice-col">
      <p align='center'>Yang Mengajukan<br>Kepala Unit <?= $data2['unit']; ?></p>
      <br>
      <br>
      <b><p align='center'><u><?= $data2['nama']; ?></u></p></b>
      </div>
    </div>
  </section>
