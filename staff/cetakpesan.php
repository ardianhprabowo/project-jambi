                ...
                <div class="box-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <a target="_blank" href="cetakbpp.php?&tgl=<?= $row['tgl_permintaan']; ?>&unit=<?= $row['unit']; ?>"><span data-placement='top' data-toggle='tooltip' title='Cetak BPP'><button id="cetakpdf" class="btn btn-success"><i class="fa fa-print"> Cetak BPP</i></button></span></a>
                                            </td>
                                </tr>
                        ...
                        <?php $no++;
                                        ...
                                        echo "<tr><td colspan=9>Belum ada BPP yang akan dicetak</td></tr>";
                                    } ?>
