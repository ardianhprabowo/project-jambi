                ...
                <form method="post" id="tes" action="add-proses.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group ">
                            ...
                            <div class="col-sm-3">
                                <input type="text" readonly value="<?= $_SESSION['divisi']; ?>" class="form-control" name="unit">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="box box-info">
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        <?php
                        $sekarang  = date("Y-m-d");
                        $queryTampil = mysqli_query($koneksi, "SELECT sementara.unit, sementara.keterangan, sementara.id_sementara, stokbarang.nama_brg, stokbarang.satuan, jumlah FROM sementara INNER JOIN stokbarang ON sementara.kode_brg  = stokbarang.kode_brg WHERE tgl_permintaan = '$sekarang' AND sementara.unit='$_SESSION[divisi]' ");
                        $no = 1;
