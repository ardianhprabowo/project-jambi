...
<table class="tabel2">
    <thead>
        <tr>
            <td colspan="4">PT. JASA RAHARJA (PERSERO)<br>CABANG JAMBI</td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td colspan="7">
                <p align="center" style="font-size: 18px;"><b><u>BUKTI PENGELUARAN BARANG</u></b><br>No.28/MU/II/2020</p>
                Kepada yth.<br>Kanit Operasional<p>Harap diterima barang tersebut dibawah ini :</p>
            </td>
        </tr>
        <tr>
...
<div class="kanan">
    Jambi, <?php
            ...
            echo date('d') . ' ' . (strtolower($bulan[date('m')])) . ' ' . date('Y')  ?><br>
    Yang Menyerahkan,
</div>
