<?php  
    ...
    if (isset($_GET['tgl']) && isset($_GET['unit'])) {
        ...
        stokbarang ON permintaan.kode_brg = stokbarang.kode_brg  WHERE tgl_permintaan='$tgl' AND unit='$unit' AND status='0' and unit = '{$_SESSION['divisi']}'");
                                ...
                                <tr>
                                    <?php 
                                     ...
                                     ?>
                                        ...
                                        <p> Menunggu Persetujuan Dari Unit HC & Umum</p>
                                        <a  href="tidaksetuju.php?tgl=<?= $tgl; ?>&unit=<?= $unit; ?>&id=<?=$row['id_permintaan']; ?>"><span data-placement='top' data-toggle='tooltip' title='Tidak Setuju'><button   class="btn btn-danger" >Batal</button></span></a>      
                                        <?php elseif ($row['status'] == 2): ?>
                                         <p> Data Permintaan Telah di Setujui Oleh Unit HC & Umum </p>
                                        <?php else: ?>
