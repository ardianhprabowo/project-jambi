<?php  
	...
	$query = mysqli_query($koneksi, "SELECT a.*, b.jabatan,c.divisi FROM user a JOIN jabatan b on a.idjabatan = b.idjabatan JOIN divisi c on a.iddivisi = c.iddivisi WHERE c.divisi='{$_SESSION['divisi']}' ORDER BY level DESC");	
