                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="get">
                            <div class="form-group">
                                ...
                                <a href="stokbarang.php?idjenis&id=<?= $id_jenis;  ?>" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data Stok</a>
                            </div>
                            <br><br>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-center" id="barang">
                            ...
                            if (isset($_GET['jenis_barang'])) {
                                $jenis_barang = trim($_GET['jenis_barang']);
                                $sql = "SELECT * FROM stokbarang WHERE jenis_barang='$jenis_barang' ";
                            } else {
