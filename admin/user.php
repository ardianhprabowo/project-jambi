<?php  
	...
	$query = mysqli_query($koneksi, "SELECT a.*, b.jabatan,c.divisi FROM user a JOIN jabatan b on a.idjabatan = b.idjabatan JOIN divisi c on a.iddivisi = c.iddivisi WHERE level!='manager' AND level!='upengadaan' ORDER BY level DESC");	
