        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">Aplikasi Inventory Aset<br>E-Factory<br>
                            <img src="gambar/logo.png" style="width: 120px; height: 100px;"></h5>
                        <form method="POST">
                            <form class="form-signin">
                                ...
                                <div class="custom-control custom-checkbox mb-3">
                                    ...
                                    <label class="custom-control-label" for="setcookie">Remember password</label>
                                </div>
                                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" value="Login" name="login">Login</button>
                            </form>
                        </form>
                    </div>
                </div>
...
>>>>>>> adf5716f35f7b365a5ca506daa1d5564ab341f9b
    </div>
